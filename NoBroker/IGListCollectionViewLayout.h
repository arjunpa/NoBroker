...
@protocol IGListCollectionViewLayoutDelegate <UICollectionViewDelegateFlowLayout>

-(CGFloat)layout:(IGListCollectionViewLayout *)layout insetXForFirstIndexPathInNewLine:(NSIndexPath *)indexPath;
